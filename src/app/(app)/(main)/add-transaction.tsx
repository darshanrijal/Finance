      ...
      >
        {loadingAccounts ? (
          ...
          <View className="flex-1 items-center justify-center px-10">
            ...
            <Text className="mt-3 text-center font-brand text-muted-foreground text-sm">
          ...
          >
            ...
            <Text className="mb-1.5 font-brand-semibold text-foreground text-xs">
              Amount
            </Text>
            ...
            <Controller
              ...
              render={({ field: { value, onChange, onBlur } }) => (
                <TextInput
                  ...
                  className="rounded-xl border border-border bg-card px-4 py-3.5 font-brand text-card-foreground text-sm"
                />
              )}
            />

            {form.formState.errors.amount && (
              <Text className="mt-1.5 font-brand text-destructive text-xs">
            ...
            {datePickerOpen ? (
              <View className="mt-1 mb-4 overflow-hidden rounded-xl border border-border bg-card">
                <CalendarPicker
                  value={date}
            ...
            {error ? (
              <View className="mt-3 flex-row items-center gap-2 rounded-xl border border-destructive/20 bg-destructive/5 px-3.5 py-3">
                <Feather name="alert-circle" size={15} color="red" />

                <Text className="flex-1 font-brand text-destructive text-xs">
                  {error}
                </Text>
              </View>
            ) : null}
      ...
      {scanning && (
        <View className="absolute inset-0 items-center justify-center bg-secondary">
          <View className="items-center rounded-2xl bg-card px-6 py-5">
            <ActivityIndicator colorClassName="accent-primary" />
            <Text className="mt-3 font-brand-semibold text-primary text-sm">
              Reading receipt…
            </Text>
          </View>
        </View>
